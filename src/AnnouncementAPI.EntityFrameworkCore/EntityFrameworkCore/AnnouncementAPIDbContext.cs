...
public class AnnouncementAPIDbContext :
    AbpDbContext<AnnouncementAPIDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AnnouncementAPIConsts.DbTablePrefix + "YourEntities", AnnouncementAPIConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});

        builder.Entity<AnnouncementsModel>(b =>
        {
