...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AnnouncementAPI") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AnnouncementAPI", DisplayName = "AnnouncementAPI API", Resources = { "AnnouncementAPI" }
            });
        }
    }
